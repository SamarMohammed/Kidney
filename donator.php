  ...
  <body>
		<header class="clearfix">
            ...
            <ul class="clearfix">
                ...
                <li><a href="donater.php" class="active">donator</a></li>
...
<body>
    ...
    <tr>
     ...
     <tr><td><br><br></td></tr>
    <tr>
       <td colspan="2" class="center">first time? <a href="don.php" class="hero-btn">Sign up</a><!--<a href="register.php">signup</a>--></td> 
    </tr>
    </table>
    </form>
</body>
